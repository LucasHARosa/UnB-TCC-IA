# -*- coding: utf-8 -*-
"""Tuning_regressão1.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1-twNSoCHTpjR_41hoW8wzTBrXb29HXWI
"""
...
def create_model(loss, optimizer):
    model = Sequential()
    model.add(Conv2D(64, (3, 3), activation='relu', input_shape=(230, 230, 1)))
...
param_grid = {
    ...
    'loss':['mean_squared_error','mean_absolute_error','mean_absolute_percentage_error','cosine_similarity'],
    'epochs': [3]
}
