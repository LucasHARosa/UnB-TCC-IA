# -*- coding: utf-8 -*-
"""Tuning_regressao2a.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1cOWIkYbSMdZ-4YfWINa0n4VRloE_jjUY

# Hiperparâmetros: Camadas de convolução e camadas ocultas
"""
...
def create_model(conv_filters, dense_units,):
    ...
    model.add(Conv2D(32, (3, 3), activation='relu', input_shape=(230, 230, 1)))
...
param_grid = {
    'batch_size':[20],
    'conv_filters': [[],[64], [64,128] , [64, 128, 256],[64, 128, 256, 512]],
    'dense_units': [[100],[100,100],[100,100,100],[100, 100, 100, 100],[100,100,100,100,100]],
    'epochs': [3]
}

regressor = KerasRegressor(build_fn=create_model)
grid = GridSearchCV(estimator=regressor, param_grid=param_grid,scoring='neg_mean_squared_error',cv=10)
